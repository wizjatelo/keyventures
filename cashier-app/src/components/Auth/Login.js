...
import { User, Lock, Eye, EyeOff, ShoppingBag, AlertCircle, CheckCircle, Key } from 'lucide-react';
...
const CashierLogin = () => {
  ...
  const [showCashierKey, setShowCashierKey] = useState(false);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await login(formData.username, formData.password, 'cashier', formData.cashierKey);
      
      if (result.success) {
        setSuccess('Login successful! Redirecting to cashier dashboard...');
        setTimeout(() => {
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <p style={{
            ...
            Sign in to your cashier dashboard
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              />
              <input
                type={showCashierKey ? 'text' : 'password'}
                name="cashierKey"
                value={formData.cashierKey}
                onChange={handleChange}
                placeholder="Enter your cashier security key"
                required
                style={{
                  width: '100%',
                  padding: '0.875rem 3rem 0.875rem 3rem',
              ...
              <button
                type="button"
                onClick={() => setShowCashierKey(!showCashierKey)}
                style={{
                  position: 'absolute',
                  right: '1rem',
                  top: '50%',
              ...
              >
                {showCashierKey ? <EyeOff size={20} /> : <Eye size={20} />}
              </button>
            </div>
            <p style={{
              fontSize: '0.75rem',
              ...
              Contact your manager if you don't have your security key
            </p>
          </div>
        ...
        <div style={{
          ...
          <p style={{
            ...
            This is a secure area for authorized cashiers only. All activities are logged and monitored for security purposes.
          </p>
        </div>
